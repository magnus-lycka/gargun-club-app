<footer class="items-center p-4 footer bg-neutral text-neutral-content mt-8">
    ...
    -->
		<p>Copyright © 2021, <a class="link" href="mailto:mly@gargun.club">Magnus Lyckå</a> - All right reserved</p>
	</div>
	<!--
